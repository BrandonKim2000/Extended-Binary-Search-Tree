...
/**
 * Testing program for the XBSTree data structure.
 * 
 * Input may be read from standard input/output or from files. See the comments
 * below. This creates a new XBSTree and then invokes the CommandHandler to
 * process the commands.
 */
public class XBSTreeTester {
	...
	public static void main(String[] args) {
		...
		try {
			...
			XBSTree<String, Airport> xbsTree = new XBSTree<String, Airport>(); // create the tree
			CommandHandler commandHandler = new CommandHandler(xbsTree); // initialize command handler
